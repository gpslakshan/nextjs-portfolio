...
const Hero = () => {
  return (
    <div className="p-3 bg-slate-50 h-screen lg:flex lg:flex-row-reverse lg:items-center lg:space-x-3">
      ...
      <div className="max-lg:mt-12 lg:pl-4 lg:w-2/3">
        <p className="text-3xl md:text-[45px] md:leading-[48px] lg:text-[60px] lg:leading-[60px] max-lg:text-center font-medium">
          Hi! I'm Sachin. A{" "}
